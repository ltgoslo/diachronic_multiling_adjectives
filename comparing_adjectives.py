...
if __name__ == "__main__":
    ...
    parser.add_argument('--distrib', help="Use filler sets with distribution reproduction?",
                        action="store_true")
    parser.add_argument('--lengths', '-lg', dest='lengths', default="corpus_lengths.json")
    parser.add_argument('--root', '-r', default="adjectives/")
    parser.add_argument('--out_root', '-or', default="outputs/")
